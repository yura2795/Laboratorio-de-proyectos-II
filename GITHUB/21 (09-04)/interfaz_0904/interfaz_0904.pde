...
void draw(){
  ...
  stroke(rojo);
  fill(rojo);
  ellipse(160,900,10,10);
   
  stroke(255);
  fill(255);
  ellipse(160,920,10,10);
  
  
   textSize(10);
   text("Te hemos descubierto, estás nervioso", 170, 905);
   
   textSize(10);
   text("Pareces ser una persona honesta", 170, 925);
      ...
      switch (estado){
        ...
        case 3:
         ...
         // estado = 4;
          ...
          //println(decode2(byte3,byte4,offset_a));
          estado = 1;
          found=false;
         ...
         /*
          ...
          if(s<=1250)
          {
              if(decode2(byte3,byte4,offset_a)>=480)
              {
              if(latidos < decode2(byte3,byte4,offset_a))
              //if(decode2(byte3,byte4,offset_a) >= 480)
              { 
                  latidos=decode2(byte3,byte4,offset_a);              
